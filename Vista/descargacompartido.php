...
<div id="contenido" style="height: 100%; width: 90%; margin-left: auto; border: 0px solid green; border-radius:3px;">
  ...
  <form id="form" name="form" action="accion_verifica_contra.php" method="get" data-toggle="validator">
...
?>
  <div class="col-md-0 mb-1">
      ...
      <label for="clave" class="control-label"> </label>
        <input id="acprotegidoclave" name="acprotegidoclave" type="hidden" value="<?php echo$_GET["acprotegidoclave"]?>">
        <div class="invalid-feedback">
        </div>
      </div>
      ...
      <div class="col-md-3 mb-3">
        <label for="nocompartir" class="control-label">Ingrese contraseña del archivo</label>
        <input class="form-control" id="contra" name="contra"></input>
        <div class="invalid-feedback">
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="">
        <input id="btn_eje4" class="btn btn-primary" name="btn_eje4" type="submit" value="Descargar">
